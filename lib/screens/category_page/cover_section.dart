...
class CoverSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (responsive.isMobile) {
      selectedCoverImage =
      (coverImageMobile?.isNotEmpty ?? false) &&
          coverImageMobile != "null"
          ? coverImageMobile
          : coverImage;
    } else if (responsive.isTablet) {
      selectedCoverImage =
      (coverImageTab?.isNotEmpty ?? false) &&
          coverImageTab != "null"
          ? coverImageTab
          : coverImage;
    } else if (responsive.isLaptop) {
      selectedCoverImage =
      (coverImageLaptop?.isNotEmpty ?? false) &&
          coverImageLaptop != "null"
          ? coverImageLaptop
          : coverImage;
    } else {
      selectedCoverImage =
            ...
            child: SizedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  HtmlWidget(
                    key: ValueKey('coverDescription-${_tierLabel(responsive)}'),
                    coverDesc ?? "",
                    customStylesBuilder: (element) {
